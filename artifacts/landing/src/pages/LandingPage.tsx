...
const COIN_LOCAL_LOGO: Record<string, string> = {
  BONK:   "/landing/coins/BONK.webp",
  WIF:    "/landing/coins/WIF.webp",
  SOL:    "/landing/coins/SOL.webp",
  POPCAT: "/landing/coins/POPCAT.webp",
  JUP:    "/landing/coins/JUP.webp",
  TRUMP:  "/landing/coins/TRUMP.webp",
  DOGE:   "/landing/coins/DOGE.png",
  PEPE:   "/landing/coins/PEPE.png",
};
...
function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <motion.div
        style={{ position: "relative", zIndex: 10, textAlign: "center", maxWidth: 800, rotateX, rotateY, transformStyle: "preserve-3d" }}
      >
        {/* Badge */}
        <motion.div
        ...
        >
          <h1 style={{ fontFamily: "Instrument Serif, serif", fontStyle: "italic", fontSize: "clamp(52px, 8vw, 96px)", color: "white", lineHeight: 0.9, margin: "0 0 16px", letterSpacing: "-0.02em" }}>
            Solana
          </h1>
          <h1 style={{
            fontFamily: "Instrument Serif, serif", fontStyle: "italic",
            fontSize: "clamp(52px, 8vw, 96px)", lineHeight: 0.9, margin: "0 0 24px", letterSpacing: "-0.02em",
            background: "linear-gradient(135deg, #ff2d8a 0%, #9b45ff 40%, #00e5ff 100%)",
            WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text",
          }}>
            Memecoins.
          </h1>
          <p style={{ fontFamily: "Instrument Serif, serif", fontStyle: "italic", fontSize: "clamp(24px, 3vw, 36px)", color: "rgba(255,255,255,0.55)", lineHeight: 1.1, margin: "0 0 32px" }}>
        ...
        <motion.p
          ...
          style={{ fontFamily: "Barlow, sans-serif", fontWeight: 300, fontSize: 17, color: "rgba(255,255,255,0.5)", maxWidth: 520, margin: "0 auto 40px", lineHeight: 1.6 }}
        >
...
function Problems() {
  ...
  return (
    <section style={{ padding: "100px 24px", background: "#080010" }}>
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h2 style={{ fontFamily: "Instrument Serif, serif", fontStyle: "italic", fontSize: "clamp(36px, 5vw, 60px)", color: "white", margin: 0, lineHeight: 0.9 }}>
    ...
    <section id="how-it-works" style={{ padding: "100px 24px", position: "relative", overflow: "hidden", background: "linear-gradient(180deg, #080010 0%, #0d0020 50%, #080010 100%)" }}>
      ...
      <div style={{ maxWidth: 960, margin: "0 auto", position: "relative", zIndex: 1 }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h2 style={{ fontFamily: "Instrument Serif, serif", fontStyle: "italic", fontSize: "clamp(36px, 5vw, 60px)", color: "white", margin: 0, lineHeight: 0.95 }}>
...
function Features() {
  ...
  return (
    <section id="features" style={{ padding: "100px 24px", background: "#080010" }}>
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          <div className="liquid-glass" style={{ display: "inline-flex", borderRadius: 9999, padding: "6px 16px", marginBottom: 20 }}>
...
function DataSources() {
  ...
  return (
    <section id="data-sources" style={{ padding: "100px 24px", background: "linear-gradient(180deg, #080010 0%, #0d0020 50%, #080010 100%)" }}>
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          <div className="liquid-glass" style={{ display: "inline-flex", borderRadius: 9999, padding: "6px 16px", marginBottom: 20 }}>
          ...
          <p style={{ fontFamily: "Barlow, sans-serif", fontWeight: 300, fontSize: 15, color: "rgba(255,255,255,0.4)", marginTop: 16 }}>
  ...
  return (
    <section style={{ padding: "80px 24px", background: "#080010" }}>
      <div style={{ maxWidth: 860, margin: "0 auto" }}>
        <div className="liquid-glass" style={{ borderRadius: 24, padding: "48px 40px", background: "linear-gradient(135deg, rgba(155,69,255,0.06) 0%, rgba(0,229,255,0.04) 100%)" }}>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 32, textAlign: "center" }}>
            {stats.map((s, i) => (
              <motion.div
                ...
                transition={{ delay: i * 0.1 }}
              >
                <div style={{ fontFamily: "Instrument Serif, serif", fontStyle: "italic", fontSize: "clamp(40px, 5vw, 60px)", color: s.c, marginBottom: 6, textShadow: `0 0 30px ${s.c}60` }}>{s.v}</div>
                <div style={{ fontFamily: "Barlow, sans-serif", fontWeight: 300, fontSize: 13, color: "rgba(255,255,255,0.35)" }}>{s.l}</div>
              </motion.div>
            ))}
          </div>
        </div>
    ...
    <section style={{ padding: "100px 24px 60px", position: "relative", overflow: "hidden", background: "linear-gradient(180deg, #080010 0%, #0d0020 100%)" }}>
      ...
      <div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 style={{ fontFamily: "Instrument Serif, serif", fontStyle: "italic", fontSize: "clamp(44px, 7vw, 80px)", color: "white", lineHeight: 0.9, margin: "0 0 24px", letterSpacing: "-0.02em" }}>
            Your edge starts<br />
          ...
          <p style={{ fontFamily: "Barlow, sans-serif", fontWeight: 300, fontSize: 17, color: "rgba(255,255,255,0.4)", margin: "0 0 40px", lineHeight: 1.6 }}>
